 ...
 * Size: 110 px
 * Bpp: 4
 * Opts: --font .pio/libdeps/adafruit_metro_esp32s3/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --size 110 --bpp 4 --format lvgl --lv-include lvgl.h --no-compress --symbols 0123456789.- -o src/display/font_temp_110.c
 ******************************************************************************/
...
#ifndef FONT_TEMP_110
#define FONT_TEMP_110 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 674, .box_w = 30, .box_h = 10, .ofs_x = 6, .ofs_y = 26},
    {.bitmap_index = 150, .adv_w = 400, .box_w = 15, .box_h = 16, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 270, .adv_w = 1174, .box_w = 64, .box_h = 80, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 2830, .adv_w = 651, .box_w = 30, .box_h = 77, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3985, .adv_w = 1010, .box_w = 59, .box_h = 78, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 6286, .adv_w = 1007, .box_w = 58, .box_h = 79, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 8577, .adv_w = 1177, .box_w = 69, .box_h = 77, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 11234, .adv_w = 1010, .box_w = 59, .box_h = 79, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 13565, .adv_w = 1086, .box_w = 60, .box_h = 80, .ofs_x = 5, .ofs_y = -1},
    {.bitmap_index = 15965, .adv_w = 1052, .box_w = 59, .box_h = 77, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 18237, .adv_w = 1133, .box_w = 62, .box_h = 79, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 20686, .adv_w = 1086, .box_w = 60, .box_h = 79, .ofs_x = 3, .ofs_y = -1}
};
...
{
    5, -12, 12, -32, -23, -35, 12, 0,
    -18, 0, 0, -12, 0, -21, -23, 18,
    18, -16, 0, -23, 18, 0, 12, -21,
    0, -5, -5, -18, 0, 0, -12, 0,
    0, -12, 18, -5, 0, 0, 0, -33,
    0, -5, 0, 0, 0, 0, 0, 0,
    -9, -9, 0, -18, -21, 0, 0, 18,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_temp_110 = {
#else
lv_font_t font_temp_110 = {
#endif
